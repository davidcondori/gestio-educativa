...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="escritorio.php" class="logo">
      ...
      <span class="logo-mini"><b>I.D.S. </b> S</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>U.E.</b> I.D.S.</span>
    </a>
...
if ($_SESSION['acceso']==1) {
  echo '  <li class="treeview">
        ...
        <li><a href="https://www.itds.edu.bo//" target="_blanck"><i class="fa  fa-exclamation-circle"></i> <span>Acerca de</span><small class="label pull-right bg-yellow">ComCod</small></a></li>   
